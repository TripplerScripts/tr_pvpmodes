...
export default () => lib.callback.register('removePlayerFriendship', async (source: string, identity: number) => callback(source, identity))
export type RemovePlayerFriendship = ReturnType<typeof callback>