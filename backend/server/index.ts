import { createDatabaseTable, getSingleRow, getSingleColumn, updateSingleColumn, insertNewRow } from './database'
...
lib.callback.register('cancelOutgoingFriendship', async (source: string, name: string): Promise<void> => {
  ...
  updateSingleColumn('tr_competitive_users', 'outgoingInvitations', 'license', JSON.stringify(senderRequests), license)
  updateSingleColumn('tr_competitive_users', 'incomingInvitations', 'name', JSON.stringify(receiverRequests), name)
})
...
lib.callback.register('removeIncomingRequest', async (source: string, name: string): Promise<void> => {
  ...
  updateSingleColumn('tr_competitive_users', 'incomingInvitations', 'license', JSON.stringify(senderRequests), license)
  updateSingleColumn('tr_competitive_users', 'outgoingInvitations', 'name', JSON.stringify(receiverRequests), name)
})
